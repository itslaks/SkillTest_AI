...
export const adminGuideSections: AdminGuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'For bulk import, upload CSV, XLSX/XLS, XML, JSON, DOCX, or PDF files with employee email, name, domain, and employee ID columns.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Add questions by AI generation, direct structured upload, document upload, or both. Supported uploads include CSV, XLSX/XLS, XML, JSON, DOCX, and PDF.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Attach template name, question file name, or upload the question file as CSV, XLSX/XLS, XML, JSON, DOCX, or PDF.',
