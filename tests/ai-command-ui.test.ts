...
test('training session creation syncs trainer, learner attendance, meeting links, and notifications', () => {
  ...
  assert.match(syncSource, /learnerIds/)
  ...
  assert.match(trainingActions, /resolveSessionLearnerIds/)
  assert.match(trainingActions, /trainer_employee_assignments/)
  assert.match(trainingActions, /learnerIds: employeeIds/)
  ...
  assert.match(chatbotRoute, /trainer_employee_assignments/)
  assert.match(chatbotRoute, /learnerIds: selectedEmployees\.map/)
  ...
  assert.match(sessionForm, /all visible employees will receive the session mail/)
