...
const navLinks = [
  ...
  { name: "Why SkillTest", href: "#why-skilltest" },
];
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl" : "text-2xl"}`}>SkillTest</span>
